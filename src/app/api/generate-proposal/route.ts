...
function getPromptForSection(section: string): string {
  ...
  const prompts: Record<string, string> = {
    ...
    2. 3-5 bullet points of specific, measurable objectives
    3. A brief closing statement tying objectives to client success
    ...
    Include deliverables, timeline, and clear boundaries of what is included and excluded.`,

    methodology: `Create a "Methodology" section explaining your approach to achieving the client's objectives.
    Detail your process, tools, and techniques in a clear, organized manner.`,
